...
ScVersion = "Kort's Spellcrafting Calulator 1.92"
...
GemLiquids = d2({
    ...
    'Glacial' :            'Heat From an Unearthly Pyre',
    'Cinder' :             'Treant Blood',
    'Radiant' :            'Treant Blood',
    'Magnetic' :           'Swamp Fog',
    'Clout' :              'Heat From an Unearthly Pyre',
})
...
skillTable = { 
    ...
    'Hibernia' : {
        ...
        'Aura Manipulation' : ('Radiant', 'Arcane Spell Stone'),
        ...
        'Magnetism' :         ('Magnetic', 'Arcane Spell Stone'),
        ...
        'Power Strikes' :     ('Clout', 'Arcane Spell Stone'),
