...
class B_CraftWindow(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.resize(QSize(523,373).expandedTo(self.minimumSizeHint()))
    ...
    def languageChange(self):
        self.setCaption(self.__tr("Working Item Detail"))
        self.TextLabel8.setText(self.__tr("Total Cost:"))
        self.Close.setText(self.__tr("Close"))
        self.TotalCost.setText(self.__tr("0c"))
        self.GroupBox1.setTitle(self.__tr("Gems"))
        self.TextLabel1.setText(self.__tr("Done:"))
        self.TextLabel5.setText(self.__tr("Remakes:"))
        self.TextLabel6.setText(self.__tr("Time (m):"))
        self.TextLabel7.setText(self.__tr("Cost:"))
        self.Gem1Cost.setText(self.__tr("0c"))
        self.Gem3Cost.setText(self.__tr("0c"))
        self.Gem3Name.setText(self.__tr("None"))
        self.Gem4Name.setText(self.__tr("None"))
        self.Gem3Time.setText(self.__tr("0"))
        self.Gem4Time.setText(self.__tr("0"))
        self.TextLabel2.setText(self.__tr("Name:"))
        self.Gem2Done.setText(self.__tr("Gem 2:"))
        self.Gem3Done.setText(self.__tr("Gem 3:"))
        self.Gem4Done.setText(self.__tr("Gem 4:"))
        self.Gem1Qua.setText(self.__tr("99%"))
        self.Gem2Qua.setText(self.__tr("99%"))
        self.Gem3Qua.setText(self.__tr("99%"))
        self.Gem4Qua.setText(self.__tr("99%"))
        self.Gem1Name.setText(self.__tr("None"))
        self.Gem2Name.setText(self.__tr("None"))
        self.Gem1Time.setText(self.__tr("0"))
        self.Gem2Time.setText(self.__tr("0"))
        self.Gem2Cost.setText(self.__tr("0c"))
        self.Gem4Cost.setText(self.__tr("0c"))
        self.Gem1Done.setText(self.__tr("Gem 1:"))
        self.GroupBox2_2.setTitle(self.__tr("Materials (used)"))
        self.GroupBox2_2_2.setTitle(self.__tr("Materials (expected)"))
        self.TextLabel1_2.setText(self.__tr("Expected Multiplier"))
    ...
    def __tr(self,s,c = None):
        return qApp.translate("B_CraftWindow",s,c)
