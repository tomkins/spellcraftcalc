...
# XXX       self.Effect[i].setInsertionPolicy(QComboBox.BeforeCurrent)
        ...
        self.filemenu.addAction('&New', self, SLOT('newFile()'), QKeySequence(Qt.CTRL+Qt.Key_N))
        self.filemenu.addAction('&Open...', self, SLOT('openFile()'), QKeySequence(Qt.CTRL+Qt.Key_O))
        self.filemenu.addAction('&Save', self, SLOT('saveFile()'), QKeySequence(Qt.CTRL+Qt.Key_S))
        self.filemenu.addAction('Save &As...', self, SLOT('saveAsFile()'))
        self.filemenu.addSeparator()
        self.filemenu.addAction('Export &Quickbars...', self, SLOT('openCraftBars()'))
        self.filemenu.addAction('Export &UI XML (Beta)...', self, SLOT('generateUIXML()'))
        self.filemenu.addSeparator()
        self.filemenu.addAction('&Recent Files', self, SLOT('rf_menu()'))
        self.filemenu.addSeparator()
        ...
        for piece in range(0,len(PieceTabList)):
            ...
            self.connect(self.menuBar(), SIGNAL("triggered(QAction*)"), self, SLOT('swapWith(QAction*)'))
        ...
        self.editmenu.addAction('S&wap Gems With...', self, SLOT('swapGems()'))
        self.editmenu.addSeparator()
        self.editmenu.addAction('&Options...', self, SLOT('openOptions()'))
        self.menuBar().addMenu(self.editmenu)

        self.viewmenu = QMenu('&View', self)
        self.showcapmenuid = self.viewmenu.addAction('Distance to &Cap', self, SLOT('showCap()'))
        self.showcapmenuid.setCheckable(True)
        self.showcapmenuid.setChecked(self.capDistance)
        self.viewmenu.addSeparator()
        self.viewmenu.addAction('&Configuration', self, SLOT('openConfigReport()'), QKeySequence(Qt.CTRL+Qt.Key_C))
        self.viewmenu.addAction('Choose Format...', self, SLOT('chooseReportFile()'))
        self.viewmenu.addSeparator()
        self.viewmenu.addAction('&Materials', self.openMaterialsReport, Qt.CTRL+Qt.Key_M)
        self.menuBar().addMenu(self.viewmenu)

        self.errorsmenu = QMenu('Errors', self)
        self.errorsmenu.addSeparator()
        self.errorsmenuid = self.menuBar().addAction('&Errors', self, SLOT('errorsmenu()'))
        self.errorsmenuid.setEnabled(False)

        self.helpmenu = QMenu('&Help', self)
        self.helpmenu.addAction('&About', self, SLOT('aboutBox()'))
