...
class Ui_B_ItemLevel(object):
    def setupUi(self, B_ItemLevel):
        ...
        QtCore.QObject.connect(self.Armor,QtCore.SIGNAL("clicked()"),B_ItemLevel.TypeChanged)
        QtCore.QObject.connect(self.ClothArmor,QtCore.SIGNAL("clicked()"),B_ItemLevel.TypeChanged)
        QtCore.QObject.connect(self.Weapon,QtCore.SIGNAL("clicked()"),B_ItemLevel.TypeChanged)
        QtCore.QObject.connect(self.Shield,QtCore.SIGNAL("clicked()"),B_ItemLevel.TypeChanged)
        QtCore.QObject.connect(self.ReinforcedShield,QtCore.SIGNAL("clicked()"),B_ItemLevel.TypeChanged)
        QtCore.QObject.connect(self.Level,QtCore.SIGNAL("textChanged(const QString&)"),B_ItemLevel.LevelChanged)
        QtCore.QObject.connect(self.Level,QtCore.SIGNAL("lostFocus()"),B_ItemLevel.LevelDone)
        QtCore.QObject.connect(self.AFDPS,QtCore.SIGNAL("textChanged(const QString&)"),B_ItemLevel.AFDPSChanged)
        QtCore.QObject.connect(self.AFDPS,QtCore.SIGNAL("lostFocus()"),B_ItemLevel.AFDPSDone)
        QtCore.QObject.connect(self.ShieldType,QtCore.SIGNAL("activated(const QString&)"),B_ItemLevel.ShieldChanged)
        QtCore.QObject.connect(self.OK,QtCore.SIGNAL("clicked()"),B_ItemLevel.OkClicked)
        QtCore.QObject.connect(self.Cancel,QtCore.SIGNAL("clicked()"),B_ItemLevel.CancelClicked)
