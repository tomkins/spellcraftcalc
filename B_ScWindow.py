...
# Form implementation generated from reading ui file 'ScWindow2.ui'
#
# Created: Wed Jun 1 09:04:48 2005
...
class B_SC(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.CharClass = QComboBox(0,self.GroupBox9,"CharClass")
        ...
        self.CharRace = QComboBox(0,self.GroupBox9,"CharRace")
        ...
        self.PieceSelection = QButtonGroup(self,"PieceSelection")
        self.PieceSelection.setGeometry(QRect(3,217,775,29))
        self.PieceSelection.setLineWidth(0)
        self.PieceSelection.setExclusive(1)

        self.Select0 = QPushButton(self.PieceSelection,"Select0")
        self.Select0.setGeometry(QRect(1,3,59,26))
        self.Select0.setToggleButton(1)
        self.Select0.setOn(1)
        self.PieceSelection.insert( self.Select0,0)

        self.Select1 = QPushButton(self.PieceSelection,"Select1")
        self.Select1.setGeometry(QRect(66,3,58,26))
        self.Select1.setToggleButton(1)
        self.PieceSelection.insert( self.Select1,1)

        self.Select2 = QPushButton(self.PieceSelection,"Select2")
        self.Select2.setGeometry(QRect(130,3,64,26))
        self.Select2.setToggleButton(1)
        self.PieceSelection.insert( self.Select2,2)

        self.Select3 = QPushButton(self.PieceSelection,"Select3")
        self.Select3.setGeometry(QRect(202,3,63,26))
        self.Select3.setToggleButton(1)
        self.PieceSelection.insert( self.Select3,3)

        self.Select4 = QPushButton(self.PieceSelection,"Select4")
        self.Select4.setGeometry(QRect(271,3,70,26))
        self.Select4.setToggleButton(1)
        self.PieceSelection.insert( self.Select4,4)

        self.Select5 = QPushButton(self.PieceSelection,"Select5")
        self.Select5.setGeometry(QRect(348,3,60,26))
        self.Select5.setToggleButton(1)
        self.PieceSelection.insert( self.Select5,5)

        self.Select6 = QPushButton(self.PieceSelection,"Select6")
        self.Select6.setGeometry(QRect(415,3,71,26))
        self.Select6.setToggleButton(1)
        self.PieceSelection.insert( self.Select6,6)

        self.Select7 = QPushButton(self.PieceSelection,"Select7")
        self.Select7.setGeometry(QRect(494,3,69,26))
        self.Select7.setToggleButton(1)
        self.PieceSelection.insert( self.Select7,7)

        self.Select8 = QPushButton(self.PieceSelection,"Select8")
        self.Select8.setGeometry(QRect(569,3,73,26))
        self.Select8.setToggleButton(1)
        self.PieceSelection.insert( self.Select8,8)

        self.Select9 = QPushButton(self.PieceSelection,"Select9")
        self.Select9.setGeometry(QRect(648,3,57,26))
        self.Select9.setToggleButton(1)
        self.PieceSelection.insert( self.Select9,9)

        self.Select10 = QPushButton(self.PieceSelection,"Select10")
        self.Select10.setGeometry(QRect(711,3,53,26))
        self.Select10.setToggleButton(1)
        self.PieceSelection.insert( self.Select10,10)

        self.TypeSelection = QButtonGroup(self,"TypeSelection")
        self.TypeSelection.setGeometry(QRect(3,188,226,30))
        self.TypeSelection.setLineWidth(0)
        self.TypeSelection.setMargin(0)
        self.TypeSelection.setExclusive(1)

        self.JewelrySelect = QPushButton(self.TypeSelection,"JewelrySelect")
        self.JewelrySelect.setGeometry(QRect(126,2,98,26))
        self.JewelrySelect.setToggleButton(1)
        self.TypeSelection.insert( self.JewelrySelect,1)

        self.ArmorSelect = QPushButton(self.TypeSelection,"ArmorSelect")
        self.ArmorSelect.setGeometry(QRect(2,2,118,26))
        self.ArmorSelect.setToggleButton(1)
        self.ArmorSelect.setOn(1)
        self.TypeSelection.insert( self.ArmorSelect,0)

        self.frame3 = QGroupBox(self,"frame3")
        self.frame3.setGeometry(QRect(2,251,776,267))
        ...
        self.QualDrop = QComboBox(0,self.frame3,"QualDrop")
        ...
        self.Type_1 = QComboBox(0,self.frame3,"Type_1")
        ...
        self.Amount_Drop_1 = QComboBox(0,self.frame3,"Amount_Drop_1")
        self.Amount_Drop_1.setGeometry(QRect(177,48,52,22))

        self.Effect_1 = QComboBox(0,self.frame3,"Effect_1")
        self.Effect_1.setGeometry(QRect(233,48,150,22))

        self.Quality_1 = QComboBox(0,self.frame3,"Quality_1")
        ...
        self.Amount_Drop_2 = QComboBox(0,self.frame3,"Amount_Drop_2")
        self.Amount_Drop_2.setGeometry(QRect(177,69,52,22))

        self.Type_2 = QComboBox(0,self.frame3,"Type_2")
        self.Type_2.setGeometry(QRect(46,69,127,22))

        self.Effect_2 = QComboBox(0,self.frame3,"Effect_2")
        self.Effect_2.setGeometry(QRect(233,69,150,22))

        self.Quality_2 = QComboBox(0,self.frame3,"Quality_2")
        ...
        self.Type_3 = QComboBox(0,self.frame3,"Type_3")
        ...
        self.Amount_Drop_3 = QComboBox(0,self.frame3,"Amount_Drop_3")
        self.Amount_Drop_3.setGeometry(QRect(177,90,52,22))

        self.Effect_3 = QComboBox(0,self.frame3,"Effect_3")
        self.Effect_3.setGeometry(QRect(233,90,150,22))

        self.Quality_3 = QComboBox(0,self.frame3,"Quality_3")
        ...
        self.Type_4 = QComboBox(0,self.frame3,"Type_4")
        ...
        self.Amount_Drop_4 = QComboBox(0,self.frame3,"Amount_Drop_4")
        self.Amount_Drop_4.setGeometry(QRect(177,111,52,22))

        self.Effect_4 = QComboBox(0,self.frame3,"Effect_4")
        self.Effect_4.setGeometry(QRect(233,111,150,22))

        self.Quality_4 = QComboBox(0,self.frame3,"Quality_4")
        ...
        self.Type_5 = QComboBox(0,self.frame3,"Type_5")
        ...
        self.Effect_5 = QComboBox(0,self.frame3,"Effect_5")
        ...
        self.Type_6 = QComboBox(0,self.frame3,"Type_6")
        ...
        self.Effect_6 = QComboBox(0,self.frame3,"Effect_6")
        ...
        self.Type_7 = QComboBox(0,self.frame3,"Type_7")
        ...
        self.Effect_7 = QComboBox(0,self.frame3,"Effect_7")
        ...
        self.Type_8 = QComboBox(0,self.frame3,"Type_8")
        ...
        self.Effect_8 = QComboBox(0,self.frame3,"Effect_8")
        ...
        self.Type_9 = QComboBox(0,self.frame3,"Type_9")
        ...
        self.Effect_9 = QComboBox(0,self.frame3,"Effect_9")
        ...
        self.Type_10 = QComboBox(0,self.frame3,"Type_10")
        ...
        self.Effect_10 = QComboBox(0,self.frame3,"Effect_10")
        ...
        self.connect(self.TypeSelection,SIGNAL("clicked(int)"),self.ItemTypeChanged)
        self.connect(self.PieceSelection,SIGNAL("clicked(int)"),self.PieceTypeChanged)
        ...
        self.setTabOrder(self.CapDistance,self.ItemLevel)
    ...
    def languageChange(self):
        ...
        self.PieceSelection.setTitle(QString.null)
        self.Select0.setText(self.__tr("Chest"))
        self.Select1.setText(self.__tr("Arms"))
        self.Select2.setText(self.__tr("Head"))
        self.Select3.setText(self.__tr("Legs"))
        self.Select4.setText(self.__tr("Hands"))
        self.Select5.setText(self.__tr("Feet"))
        self.Select6.setText(self.__tr("Right Hand"))
        self.Select7.setText(self.__tr("Left Hand"))
        self.Select8.setText(self.__tr("2 Handed"))
        self.Select9.setText(self.__tr("Ranged"))
        self.Select10.setText(self.__tr("Spare"))
        self.TypeSelection.setTitle(QString.null)
        self.JewelrySelect.setText(self.__tr("Jewelry"))
        self.ArmorSelect.setText(self.__tr("Armor/Weapons"))
