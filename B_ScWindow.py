...
#
# Created: Thu Mar  1 04:24:21 2007
...
class Ui_B_SC(object):
    def setupUi(self, B_SC):
        ...
        spacerItem3 = QtGui.QSpacerItem(1,0,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.MinimumExpanding)
        self.gridlayout2.addItem(spacerItem3,14,0,1,3)
        ...
        spacerItem5 = QtGui.QSpacerItem(1,1,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.MinimumExpanding)
        ...
        spacerItem7 = QtGui.QSpacerItem(1,2,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Fixed)
        ...
        spacerItem9 = QtGui.QSpacerItem(1,2,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Fixed)
        ...
        self.LabelItemRealm = QtGui.QLabel(self.ItemInfoFrame)
        ...
        self.ItemRealm = SearchingCombo(self.ItemInfoFrame)
        self.ItemRealm.setObjectName("ItemRealm")
        self.gridlayout5.addWidget(self.ItemRealm,0,1,1,3)

        self.LabelItemType = QtGui.QLabel(self.ItemInfoFrame)
        ...
        self.ItemType = SearchingCombo(self.ItemInfoFrame)
        ...
        self.gridlayout5.addWidget(self.LabelAFDPSEdit,4,0,1,1)

        self.AFDPSEdit = QtGui.QLineEdit(self.ItemInfoFrame)
        self.AFDPSEdit.setObjectName("AFDPSEdit")
        self.gridlayout5.addWidget(self.AFDPSEdit,4,1,1,1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LabelBonusEdit.sizePolicy().hasHeightForWidth())
        self.LabelBonusEdit.setSizePolicy(sizePolicy)
        self.LabelBonusEdit.setTextFormat(QtCore.Qt.PlainText)
        self.LabelBonusEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.LabelBonusEdit.setObjectName("LabelBonusEdit")
        self.gridlayout5.addWidget(self.LabelBonusEdit,4,2,1,1)

        self.BonusEdit = QtGui.QLineEdit(self.ItemInfoFrame)
        self.BonusEdit.setObjectName("BonusEdit")
        self.gridlayout5.addWidget(self.BonusEdit,4,3,1,1)
        ...
        spacerItem14 = QtGui.QSpacerItem(1,0,QtGui.QSizePolicy.MinimumExpanding,QtGui.QSizePolicy.Minimum)
        ...
        spacerItem16 = QtGui.QSpacerItem(1,3,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Fixed)
        ...
        spacerItem17 = QtGui.QSpacerItem(1,3,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.MinimumExpanding)
        ...
        self.gridlayout6 = QtGui.QGridLayout(self.ItemSlotsFrame)
        ...
        self.gridlayout6.addWidget(self.Points_1,1,5,1,1)
        ...
        self.gridlayout6.addWidget(self.Cost_1,1,6,1,1)

        self.Name_1 = QtGui.QLabel(self.ItemSlotsFrame)
        self.Name_1.setObjectName("Name_1")
        self.gridlayout6.addWidget(self.Name_1,1,8,1,2)
        ...
        self.gridlayout6.addWidget(self.Points_2,2,5,1,1)
        ...
        self.gridlayout6.addWidget(self.Cost_2,2,6,1,1)

        self.Name_2 = QtGui.QLabel(self.ItemSlotsFrame)
        self.Name_2.setObjectName("Name_2")
        self.gridlayout6.addWidget(self.Name_2,2,8,1,2)
        ...
        self.gridlayout6.addWidget(self.Points_3,3,5,1,1)
        ...
        self.gridlayout6.addWidget(self.Cost_3,3,6,1,1)

        self.Name_3 = QtGui.QLabel(self.ItemSlotsFrame)
        self.Name_3.setObjectName("Name_3")
        self.gridlayout6.addWidget(self.Name_3,3,8,1,2)
        ...
        self.gridlayout6.addWidget(self.Points_4,4,5,1,1)
        ...
        self.gridlayout6.addWidget(self.Cost_4,4,6,1,1)

        self.Name_4 = QtGui.QLabel(self.ItemSlotsFrame)
        self.Name_4.setObjectName("Name_4")
        self.gridlayout6.addWidget(self.Name_4,4,8,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemImbueLabel,8,3,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemImbue,8,5,1,1)
        ...
        self.gridlayout6.addWidget(self.ItemImbueTotal,8,6,1,1)
        ...
        self.gridlayout6.addWidget(self.ItemOverchargeLabel,9,3,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemOvercharge,9,5,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemCostLabel,10,3,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemCost,10,5,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemPriceLabel,11,3,1,2)
        ...
        self.gridlayout6.addWidget(self.ItemPrice,11,5,1,2)
        ...
        self.gridlayout6.addLayout(self.hboxlayout4,12,8,1,1)

        spacerItem24 = QtGui.QSpacerItem(20,5,QtGui.QSizePolicy.Preferred,QtGui.QSizePolicy.Minimum)
        self.gridlayout6.addItem(spacerItem24,12,9,1,1)
    ...
    def retranslateUi(self, B_SC):
        ...
        self.LabelAFDPSEdit.setText(QtGui.QApplication.translate("B_SC", "AF/DPS: ", None, QtGui.QApplication.UnicodeUTF8))
