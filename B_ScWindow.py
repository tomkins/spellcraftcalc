...
class B_SC(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.StrLabel.setGeometry(QRect(6,16,28,16))
        self.StrLabel.setText(self.tr("STR:"))

        self.Str = QLabel(self.GroupBox1,'Str')
        self.Str.setGeometry(QRect(35,16,20,16))
        self.Str.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Str.setText(self.tr("0"))

        self.StrCap = QLabel(self.GroupBox1,'StrCap')
        self.StrCap.setGeometry(QRect(57,16,20,16))
        self.StrCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.StrCap.setText(self.tr("-"))

        self.ConLabel = QLabel(self.GroupBox1,'ConLabel')
        self.ConLabel.setGeometry(QRect(6,32,28,16))
        self.ConLabel.setText(self.tr("CON:"))

        self.Con = QLabel(self.GroupBox1,'Con')
        self.Con.setGeometry(QRect(35,32,20,16))
        self.Con.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Con.setText(self.tr("0"))

        self.ConCap = QLabel(self.GroupBox1,'ConCap')
        self.ConCap.setGeometry(QRect(57,32,20,16))
        self.ConCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.ConCap.setText(self.tr("-"))

        self.DexLabel = QLabel(self.GroupBox1,'DexLabel')
        self.DexLabel.setGeometry(QRect(6,48,28,16))
        self.DexLabel.setText(self.tr("DEX:"))

        self.Dex = QLabel(self.GroupBox1,'Dex')
        self.Dex.setGeometry(QRect(35,48,20,16))
        self.Dex.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Dex.setText(self.tr("0"))

        self.DexCap = QLabel(self.GroupBox1,'DexCap')
        self.DexCap.setGeometry(QRect(57,48,20,16))
        self.DexCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.DexCap.setText(self.tr("-"))

        self.QuiLabel = QLabel(self.GroupBox1,'QuiLabel')
        self.QuiLabel.setGeometry(QRect(6,64,28,16))
        self.QuiLabel.setText(self.tr("QUI:"))

        self.Qui = QLabel(self.GroupBox1,'Qui')
        self.Qui.setGeometry(QRect(35,64,20,16))
        self.Qui.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Qui.setText(self.tr("0"))

        self.QuiCap = QLabel(self.GroupBox1,'QuiCap')
        self.QuiCap.setGeometry(QRect(57,64,20,16))
        self.QuiCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.QuiCap.setText(self.tr("-"))

        self.IntLabel = QLabel(self.GroupBox1,'IntLabel')
        self.IntLabel.setGeometry(QRect(6,80,28,16))
        self.IntLabel.setText(self.tr("INT:"))

        self.Int = QLabel(self.GroupBox1,'Int')
        self.Int.setGeometry(QRect(35,80,20,16))
        self.Int.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Int.setText(self.tr("0"))

        self.IntCap = QLabel(self.GroupBox1,'IntCap')
        self.IntCap.setGeometry(QRect(57,80,20,16))
        self.IntCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.IntCap.setText(self.tr("-"))

        self.PieLabel = QLabel(self.GroupBox1,'PieLabel')
        self.PieLabel.setGeometry(QRect(6,96,28,16))
        self.PieLabel.setText(self.tr("PIE:"))

        self.Pie = QLabel(self.GroupBox1,'Pie')
        self.Pie.setGeometry(QRect(35,96,20,16))
        self.Pie.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Pie.setText(self.tr("0"))

        self.PieCap = QLabel(self.GroupBox1,'PieCap')
        self.PieCap.setGeometry(QRect(57,96,20,16))
        self.PieCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.PieCap.setText(self.tr("-"))

        self.ChaLabel = QLabel(self.GroupBox1,'ChaLabel')
        self.ChaLabel.setGeometry(QRect(6,112,28,16))
        self.ChaLabel.setText(self.tr("CHA:"))

        self.Cha = QLabel(self.GroupBox1,'Cha')
        self.Cha.setGeometry(QRect(35,112,20,16))
        self.Cha.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Cha.setText(self.tr("0"))

        self.ChaCap = QLabel(self.GroupBox1,'ChaCap')
        self.ChaCap.setGeometry(QRect(57,112,20,16))
        self.ChaCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.ChaCap.setText(self.tr("-"))

        self.EmpLabel = QLabel(self.GroupBox1,'EmpLabel')
        self.EmpLabel.setGeometry(QRect(6,128,28,16))
        self.EmpLabel.setText(self.tr("EMP:"))

        self.Emp = QLabel(self.GroupBox1,'Emp')
        self.Emp.setGeometry(QRect(35,128,20,16))
        self.Emp.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.Emp.setText(self.tr("0"))

        self.EmpCap = QLabel(self.GroupBox1,'EmpCap')
        self.EmpCap.setGeometry(QRect(57,128,20,16))
        self.EmpCap.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        self.EmpCap.setText(self.tr("-"))
