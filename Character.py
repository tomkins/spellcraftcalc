...
from tuple2 import t2
from dict2 import d2
...
AllBonusList = {
    'Albion': {
        ...
        'Armsman': {
            ...
            'Races': t2(
                ('Avalonian', 'Briton', 'Half Ogre', 'Highlander', 'Inconnu', 'Korazh', 'Saracen',)
            ),
        },
    ...
    'Hibernia': {
        ...
        'Hero': {
            'All Melee Weapon Skills': (
                'Blades', 'Blunt', 'Celtic Spear', 'Large Weaponry', 'Piercing',
            ),
            'Other Skills': ('Parry', 'Shield',),
...
spareTypes = d2({
    'Albion': t2(twohandTypes['Albion'] + rangedTypes['Albion'][:-4] + shields + spares),
    'Hibernia': t2(twohandTypes['Hibernia'] + rangedTypes['Hibernia'][:-4] + shields + spares),
    'Midgard': t2(twohandTypes['Midgard'] + rangedTypes['Midgard'] + shields + spares),
    'All': t2(twohandTypes['All'] + rangedTypes['All'][:-4] + shields + spares),
})
